...
const words = [
  ...
  {
    categoryId: 'mystery_ancient',
    question: '世界各地で発見される、自然現象か知的な力によるものか議論される、規則正しい幾何学模様は？',
    answer: 'パルパの巨大な穴・ミステリーサークル',
    hint: '謎の現象',
    examples: ['ペルーの幾何学模様', '円形の配置', '宇宙人のメッセージ説'],
  },
